...
from langchain_core.tracers._streaming import _StreamingCallbackHandler, _V2StreamingCallbackHandler
...
class StreamMessagesHandlerV2(StreamMessagesHandler, _V2StreamingCallbackHandler):
    ...
    def on_stream_event(self, event: dict[str, Any], *, run_id: UUID, parent_run_id: UUID | None = ..., tags: list[str] | None = ..., **kwargs: Any) -> Any:
