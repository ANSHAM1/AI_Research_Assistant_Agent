...
def call(func: Callable[P, Awaitable[T]] | Callable[P, T], *args: Any, retry_policy: Sequence[RetryPolicy] | None = ..., cache_policy: CachePolicy | None = ..., timeout: float | timedelta | TimeoutPolicy | None = ..., **kwargs: Any) -> SyncAsyncFuture[T]:
    ...
