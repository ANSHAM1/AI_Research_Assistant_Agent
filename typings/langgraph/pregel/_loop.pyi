...
from langgraph.callbacks import GraphLifecycleEvent
...
class PregelLoop:
    ...
    _delta_write_futs: list[Any] | None = ...
    _error_handler_write_futs: list[Any] | None = ...
    _exit_delta_writes: list[tuple[int, str, str, Any]] | None = ...
    _delta_channels_with_overwrite: set[str]
    _initial_checkpoint_config: RunnableConfig
    _has_persisted_parent: bool = ...
    ...
    status: Literal["input", "pending", "done", "draining", "interrupt_before", "interrupt_after", "out_of_steps",]
    ...
    def schedule_error_handler(self, failed_task: PregelExecutableTask, error: BaseException) -> PregelExecutableTask | None:
        ...
    
    async def aschedule_error_handler(self, failed_task: PregelExecutableTask, error: BaseException) -> PregelExecutableTask | None:
        ...
