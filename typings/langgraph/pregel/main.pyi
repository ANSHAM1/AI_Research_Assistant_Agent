...
from langgraph.types import All, CachePolicy, Checkpointer, Command, Durability, GraphOutput, StateSnapshot, StateUpdate, StreamMode, StreamPart, TimeoutPolicy
...
_V3_INVARIANT_KWARGS: tuple[str, ...] = ...
class Pregel(PregelProtocol[StateT, ContextT, InputT, OutputT], Generic[StateT, ContextT, InputT, OutputT]):
    ...
    **Actors** read data from channels and write data to channels.
    ...
    def __init__(self, *, nodes: dict[str, PregelNode | NodeBuilder], channels: dict[str, BaseChannel | ManagedValueSpec] | None, auto_validate: bool = ..., stream_mode: StreamMode = ..., stream_eager: bool = ..., output_channels: str | Sequence[str], stream_channels: str | Sequence[str] | None = ..., interrupt_after_nodes: All | Sequence[str] = ..., interrupt_before_nodes: All | Sequence[str] = ..., input_channels: str | Sequence[str], step_timeout: float | None = ..., debug: bool | None = ..., checkpointer: Checkpointer = ..., store: BaseStore | None = ..., cache: BaseCache | None = ..., retry_policy: RetryPolicy | Sequence[RetryPolicy] = ..., cache_policy: CachePolicy | None = ..., context_schema: type[ContextT] | None = ..., config: RunnableConfig | None = ..., trigger_to_nodes: Mapping[str, Sequence[str]] | None = ..., node_error_handler_map: Mapping[str, str] | None = ..., name: str = ..., stream_transformers: Sequence[Callable[[tuple[str, ...]], Any]] | None = ..., **deprecated_kwargs: Unpack[DeprecatedKwargs]) -> None:
        ...
    ...
    @overload
    def stream(self, input: InputT | Command | None, config: RunnableConfig | None = ..., *, context: ContextT | None = ..., stream_mode: StreamMode | Sequence[StreamMode] | None = ..., print_mode: StreamMode | Sequence[StreamMode] = ..., output_keys: str | Sequence[str] | None = ..., interrupt_before: All | Sequence[str] | None = ..., interrupt_after: All | Sequence[str] | None = ..., durability: Durability | None = ..., control: RunControl | None = ..., subgraphs: bool = ..., debug: bool | None = ..., version: Literal["v2"], **kwargs: Unpack[DeprecatedKwargs]) -> Iterator[StreamPart[StateT, OutputT]]:
        ...
    
    @overload
    def stream(self, input: InputT | Command | None, config: RunnableConfig | None = ..., *, context: ContextT | None = ..., stream_mode: StreamMode | Sequence[StreamMode] | None = ..., print_mode: StreamMode | Sequence[StreamMode] = ..., output_keys: str | Sequence[str] | None = ..., interrupt_before: All | Sequence[str] | None = ..., interrupt_after: All | Sequence[str] | None = ..., durability: Durability | None = ..., control: RunControl | None = ..., subgraphs: bool = ..., debug: bool | None = ..., version: Literal["v1"] = ..., **kwargs: Unpack[DeprecatedKwargs]) -> Iterator[dict[str, Any] | Any]:
        ...
    
    def stream(self, input: InputT | Command | None, config: RunnableConfig | None = ..., *, context: ContextT | None = ..., stream_mode: StreamMode | Sequence[StreamMode] | None = ..., print_mode: StreamMode | Sequence[StreamMode] = ..., output_keys: str | Sequence[str] | None = ..., interrupt_before: All | Sequence[str] | None = ..., interrupt_after: All | Sequence[str] | None = ..., durability: Durability | None = ..., control: RunControl | None = ..., subgraphs: bool = ..., debug: bool | None = ..., version: Literal["v1", "v2"] = ..., **kwargs: Unpack[DeprecatedKwargs]) -> Iterator[dict[str, Any] | Any]:
    ...
    @overload
    def astream(self, input: InputT | Command | None, config: RunnableConfig | None = ..., *, context: ContextT | None = ..., stream_mode: StreamMode | Sequence[StreamMode] | None = ..., print_mode: StreamMode | Sequence[StreamMode] = ..., output_keys: str | Sequence[str] | None = ..., interrupt_before: All | Sequence[str] | None = ..., interrupt_after: All | Sequence[str] | None = ..., durability: Durability | None = ..., control: RunControl | None = ..., subgraphs: bool = ..., debug: bool | None = ..., version: Literal["v2"], **kwargs: Unpack[DeprecatedKwargs]) -> AsyncIterator[StreamPart[StateT, OutputT]]:
        ...
    ...
    @overload
    def stream_events(self, input: InputT | Command | None, config: RunnableConfig | None = ..., *, version: Literal["v1", "v2"] = ..., **kwargs: Any) -> Iterator[StreamEvent]:
        ...
    
    @overload
    def stream_events(self, input: InputT | Command | None, config: RunnableConfig | None = ..., *, version: Literal["v3"], interrupt_before: All | Sequence[str] | None = ..., interrupt_after: All | Sequence[str] | None = ..., control: RunControl | None = ..., transformers: Sequence[Callable[[tuple[str, ...]], Any]] | None = ..., **kwargs: Any) -> Any:
        ...
    
    def stream_events(self, input: InputT | Command | None, config: RunnableConfig | None = ..., *, version: Literal["v1", "v2", "v3"] = ..., interrupt_before: All | Sequence[str] | None = ..., interrupt_after: All | Sequence[str] | None = ..., control: RunControl | None = ..., transformers: Sequence[Callable[[tuple[str, ...]], Any]] | None = ..., **kwargs: Any) -> Any:
    ...
    @overload
    def astream_events(self, input: InputT | Command | None, config: RunnableConfig | None = ..., *, version: Literal["v1", "v2"] = ..., **kwargs: Any) -> AsyncIterator[StreamEvent]:
        ...
    
    @overload
    def astream_events(self, input: InputT | Command | None, config: RunnableConfig | None = ..., *, version: Literal["v3"], interrupt_before: All | Sequence[str] | None = ..., interrupt_after: All | Sequence[str] | None = ..., control: RunControl | None = ..., transformers: Sequence[Callable[[tuple[str, ...]], Any]] | None = ..., **kwargs: Any) -> Awaitable[Any]:
        ...
    
    def astream_events(self, input: InputT | Command | None, config: RunnableConfig | None = ..., *, version: Literal["v1", "v2", "v3"] = ..., interrupt_before: All | Sequence[str] | None = ..., interrupt_after: All | Sequence[str] | None = ..., control: RunControl | None = ..., transformers: Sequence[Callable[[tuple[str, ...]], Any]] | None = ..., **kwargs: Any) -> AsyncIterator[StreamEvent] | Awaitable[Any]:
    ...
    @overload
    def invoke(self, input: InputT | Command | None, config: RunnableConfig | None = ..., *, context: ContextT | None = ..., stream_mode: Literal["values"] = ..., print_mode: StreamMode | Sequence[StreamMode] = ..., output_keys: str | Sequence[str] | None = ..., interrupt_before: All | Sequence[str] | None = ..., interrupt_after: All | Sequence[str] | None = ..., durability: Durability | None = ..., control: RunControl | None = ..., version: Literal["v2"], **kwargs: Any) -> GraphOutput[OutputT]:
        ...
    
    @overload
    def invoke(self, input: InputT | Command | None, config: RunnableConfig | None = ..., *, context: ContextT | None = ..., stream_mode: StreamMode, print_mode: StreamMode | Sequence[StreamMode] = ..., output_keys: str | Sequence[str] | None = ..., interrupt_before: All | Sequence[str] | None = ..., interrupt_after: All | Sequence[str] | None = ..., durability: Durability | None = ..., control: RunControl | None = ..., version: Literal["v2"], **kwargs: Any) -> list[StreamPart[StateT, OutputT]]:
        ...
    
    @overload
    def invoke(self, input: InputT | Command | None, config: RunnableConfig | None = ..., *, context: ContextT | None = ..., stream_mode: StreamMode = ..., print_mode: StreamMode | Sequence[StreamMode] = ..., output_keys: str | Sequence[str] | None = ..., interrupt_before: All | Sequence[str] | None = ..., interrupt_after: All | Sequence[str] | None = ..., durability: Durability | None = ..., control: RunControl | None = ..., version: Literal["v1"] = ..., **kwargs: Any) -> dict[str, Any] | Any:
        ...
    
    def invoke(self, input: InputT | Command | None, config: RunnableConfig | None = ..., *, context: ContextT | None = ..., stream_mode: StreamMode = ..., print_mode: StreamMode | Sequence[StreamMode] = ..., output_keys: str | Sequence[str] | None = ..., interrupt_before: All | Sequence[str] | None = ..., interrupt_after: All | Sequence[str] | None = ..., durability: Durability | None = ..., control: RunControl | None = ..., version: Literal["v1", "v2"] = ..., **kwargs: Any) -> dict[str, Any] | Any:
    ...
    @overload
    async def ainvoke(self, input: InputT | Command | None, config: RunnableConfig | None = ..., *, context: ContextT | None = ..., stream_mode: Literal["values"] = ..., print_mode: StreamMode | Sequence[StreamMode] = ..., output_keys: str | Sequence[str] | None = ..., interrupt_before: All | Sequence[str] | None = ..., interrupt_after: All | Sequence[str] | None = ..., durability: Durability | None = ..., control: RunControl | None = ..., version: Literal["v2"], **kwargs: Any) -> GraphOutput[OutputT]:
        ...
