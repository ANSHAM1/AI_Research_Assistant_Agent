...
from langgraph.types import All, CachePolicy, PregelExecutableTask, PregelTask, RetryPolicy, Send, TimeoutPolicy
...
class Call:
    ...
    def __init__(self, func: Callable, input: tuple[tuple[Any, ...], dict[str, Any]], *, retry_policy: Sequence[RetryPolicy] | None, cache_policy: CachePolicy | None, callbacks: Callbacks, timeout: TimeoutPolicy | None = ...) -> None:
        ...
