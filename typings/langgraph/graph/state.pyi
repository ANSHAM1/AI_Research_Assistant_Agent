...
class StateGraph(Generic[StateT, ContextT, InputT, OutputT]):
    ...
    def set_node_defaults(self, *, retry_policy: RetryPolicy | Sequence[RetryPolicy] | None = ..., cache_policy: CachePolicy | None = ..., error_handler: StateNode[Any, ContextT] | None = ..., timeout: float | timedelta | TimeoutPolicy | None = ...) -> Self:
    ...
    @overload
    def add_node(self, node: StateNode[NodeInputT, ContextT], *, defer: bool = ..., metadata: dict[str, Any] | None = ..., input_schema: None = ..., retry_policy: RetryPolicy | Sequence[RetryPolicy] | None = ..., cache_policy: CachePolicy | None = ..., error_handler: StateNode[Any, ContextT] | None = ..., destinations: dict[str, str] | tuple[str, ...] | None = ..., timeout: float | timedelta | TimeoutPolicy | None = ..., **kwargs: Unpack[DeprecatedKwargs]) -> Self:
    ...
    @overload
    def add_node(self, node: StateNode[NodeInputT, ContextT], *, defer: bool = ..., metadata: dict[str, Any] | None = ..., input_schema: type[NodeInputT], retry_policy: RetryPolicy | Sequence[RetryPolicy] | None = ..., cache_policy: CachePolicy | None = ..., error_handler: StateNode[Any, ContextT] | None = ..., destinations: dict[str, str] | tuple[str, ...] | None = ..., timeout: float | timedelta | TimeoutPolicy | None = ..., **kwargs: Unpack[DeprecatedKwargs]) -> Self:
    ...
    @overload
    def add_node(self, node: str, action: StateNode[NodeInputT, ContextT], *, defer: bool = ..., metadata: dict[str, Any] | None = ..., input_schema: None = ..., retry_policy: RetryPolicy | Sequence[RetryPolicy] | None = ..., cache_policy: CachePolicy | None = ..., error_handler: StateNode[Any, ContextT] | None = ..., destinations: dict[str, str] | tuple[str, ...] | None = ..., timeout: float | timedelta | TimeoutPolicy | None = ..., **kwargs: Unpack[DeprecatedKwargs]) -> Self:
        """Add a new node to the `StateGraph`, input schema is inferred as the state schema.
    ...
    def compile(self, checkpointer: Checkpointer = ..., *, cache: BaseCache | None = ..., store: BaseStore | None = ..., interrupt_before: All | list[str] | None = ..., interrupt_after: All | list[str] | None = ..., debug: bool = ..., name: str | None = ..., transformers: Sequence[Callable[[tuple[str, ...]], Any]] | None = ...) -> CompiledStateGraph[StateT, ContextT, InputT, OutputT]:
