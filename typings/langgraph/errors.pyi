...
__all__ = ("EmptyChannelError", "ErrorCode", "GraphDrained", "GraphRecursionError", "InvalidUpdateError", "GraphBubbleUp", "GraphInterrupt", "NodeCancelledError", "NodeError", "NodeInterrupt", "NodeTimeoutError", "ParentCommand", "EmptyInputError", "TaskNotFound")
...
class NodeTimeoutError(Exception):
    ...
    def __init__(self, node: str, elapsed: float, *, kind: Literal["idle", "run"], idle_timeout: float | None = ..., run_timeout: float | None = ...) -> None:
        ...
